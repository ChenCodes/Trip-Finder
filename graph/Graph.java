...
public abstract class Graph {
    ...
    /** Returns the neighboring edges to my vertex.
        @param u This is my current vertex.
        */
    protected abstract ArrayList<Integer> findCurrent(int u);

    /** Returns the predecessors of a vertex (undirected graph).
        @param u This is my current vertex.
        */
    protected abstract ArrayList<Integer> findPred(int u);

    /** Returns an arraylist of undirected graph neighbors.
        @param u This is also my current vertex.
        */
    protected abstract ArrayList<Integer> findUndirected(int u);

    /** Returns a queue version of my vertices. */
    protected abstract Queue<Integer> queuedVertices();

    /** Returns the arraylist that holds my vertices. */
    protected abstract ArrayList<Integer> addedVertices();

    /** Returns the arraylist that holds my removed vertices. */
    protected abstract ArrayList<Integer> removedVertices();
