...
public class GraphFilter extends Graph {
    ...
    public int outDegree(int v) {
        if (!_G.addedVertices().contains(v)
            || _G.removedVertices().contains(v)) {
            return 0;
        }
